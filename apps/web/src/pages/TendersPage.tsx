...
import { activeStatuses, daysUntil, formatDate, statusLabels } from '../lib/labels';
...
export function TendersPage() {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ['tenders', { status, entity, q, page }],
    queryFn: () => fetchTenders({ status, entity, q, page }),
