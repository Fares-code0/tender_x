...
| H2.1 — Redis-backed limiter | 🟠 | ⬜ لم يبدأ | — | عدّاد مشترك بين النسخ |
| H2.2 — حدود عامة + `Retry-After` | 🟠 | ⬜ لم يبدأ | — | 429 يتضمن Retry-After |
| H2.3 — قفل تخمين على مستوى الحساب | 🟠 | ⬜ لم يبدأ | — | اختياري |
