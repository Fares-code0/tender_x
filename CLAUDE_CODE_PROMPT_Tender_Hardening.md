...
| H4.3 — ترقيم القوائم غير المحدودة | 🟠 | ⬜ لم يبدأ | — | audit/users بلا `take` |
| H4.4 — ضبط تجمّع اتصالات Prisma | 🟠 | ⬜ لم يبدأ | — | `connection_limit`/PgBouncer |
| H4.5 — بثّ رفع الملفات | 🟠 | ⬜ لم يبدأ | — | بدل memoryStorage |
| **H5 — القابلية للتوسّع** | 🟠 | ⬜ لم يبدأ | — | S3/cron موزّع |
| H5.1 — محوّل تخزين كائني (S3) | 🟠 | ⬜ لم يبدأ | — | يتطلب اختيار المزوّد |
| H5.2 — cron موزّع/قفل | 🟠 | ⬜ لم يبدأ | — | job مرة واحدة عبر النسخ |
| H5.3 — طبقة Cache (Redis) | 🟠 | ⬜ لم يبدأ | — | اختياري |
