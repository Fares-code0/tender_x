...
| ------------------------ | -------- | ---------- | ------------- | ---------------------------- |
| H0 — مكاسب أمنية سريعة   | 🔴       | ✅ مكتمل ومُتحقَّق | 2026-07-24    | env/proxy/shutdown/readiness/ping — 5/5، 124 اختبارًا (محلي، غير مدفوع) |
| H1 — Auth/AuthZ          | 🔴/🟠    | ✅ مكتمل ومُتحقَّق | 2026-07-24    | BOLA/CSRF(strict)/jti-denylist/كلمة مرور — 4/4، 129 اختبارًا (محلي، غير مدفوع) |
